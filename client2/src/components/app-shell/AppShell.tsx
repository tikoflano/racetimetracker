...
import { RiderSearchModal } from '@/components/app-header/RiderSearchModal';
  ...
  return (
    <>
      ...
      <AppHeader
        ...
        onSearchClick={() => setRiderSearchOpen(true)}
      />
      <RiderSearchModal opened={riderSearchOpen} onClose={() => setRiderSearchOpen(false)} />
