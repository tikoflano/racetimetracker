...
import { Button, Collapse, Modal, Paper, Select, Stack, Text, TextInput } from '@mantine/core';
    ...
    >
      <Stack gap="md" pt="xs">
        ...
        <Button
          ...
          size="xs"
          leftSection={
            inviteScopesOpen ? <IconChevronDown size={14} /> : <IconChevronRight size={14} />
          }
          onClick={toggleInviteScopes}
        >
          {inviteScopesOpen ? 'Hide' : 'About scopes'}
        </Button>
        <ModalFooter onCancel={onClose} submitLabel="Invite" onSubmit={handleInvite} />
      </Stack>
    </Modal>
  );
}
