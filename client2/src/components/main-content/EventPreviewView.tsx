  ...
  return (
    <div className={classes.eventPage}>
      <header className={classes.eventHeader}>
        <div>
          <div className={classes.eventBreadcrumb}>{info.championshipName}</div>
          <h1 className={classes.eventTitle}>{info.name}</h1>
          <div className={classes.eventMetaRow}>
        ...
        <div className={classes.eventStatusGroup}>
          <Badge color="green" radius="sm" className={classes.statusBadge}>
            {info.status}
          </Badge>
          <Text className={classes.statusSubtext}>Stage 3 · Creek Run · LIVE</Text>
        </div>
      </header>
          ...
          <DataTable<RiderRow>
            ...
            columns={[
              ...
              },
              {
                ...
                textAlign: "right",
                render: (rider) => (
                  <span className={`${classes.alignRight} ${classes.monoCell}`}>
                    {rider.gap}
                  </span>
                ),
              },
              ...
              columns={[
                {
                  ...
                  width: 70,
                  render: (row) => (
                    <span className={classes.monoCell}>{row.position}</span>
                  ),
                },
                ...
                },
                {
                  ...
                  title: "Stage time",
                  render: (row) => (
                    <span className={classes.monoCell}>{row.stageTime}</span>
                  ),
                },
                {
                  accessor: "diff",
          ...
          <DataTable<ResultRow>
            ...
            columns={[
              ...
              },
              {
                ...
                title: "Total time",
                render: (row) => (
                  <span className={classes.monoCell}>{row.totalTime}</span>
                ),
              },
              {
                accessor: "stageWins",
                title: "Stage wins",
                render: (row) => (
                  <span className={classes.monoCell}>{row.stageWins}</span>
                ),
              },
              {
                accessor: "points",
