    ...
    <Stack gap="lg">
      ...
      <FilterToolbar
        filterContent={
          <Stack gap="xs">
            ...
            {filterBadges}
            <Text size="xs" c="dimmed" fw={600} tt="uppercase" mt={4}>
              Sort
            </Text>
            <Group gap="xs">
              <Select
      ...
      {champRows.length === 0 ? (
        ...
        <Paper p="md" withBorder>
          <DataTable
            ...
            onRowClick={({ record }) => navigate(`/championships/${record.championship.id}`)}
            columns={[
              {
                accessor: 'color',
                title: '',
              ...
              },
              {
                ...
                title: 'Name',
                sortable: true,
                render: (r: ChampRow) => <Text fw={500}>{r.championship.name}</Text>,
              },
              {
                accessor: 'status',
                title: 'Status',
      ...
      >
        <Stack gap="sm" pt="xs">
          <FormError
            error={
              typeof createChampForm.errors.name === 'string'
                ? createChampForm.errors.name
                : undefined
            }
          />
          <TextInput
          ...
          <ModalFooter onCancel={resetCreate} submitLabel="Create" onSubmit={handleCreate} />
        </Stack>
      </Modal>
    </Stack>
  );
