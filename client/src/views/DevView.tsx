...
export default function DevView() {
  ...
  const handleTransfer = async () => {
    ...
    if (!transferEmail.trim()) {
      setTransferStatus('Error: Enter an email');
      return;
    }
    try {
        ...
        >
          <div>
            <div className="muted small-text">
              Wipes all existing data, then creates sample championships, locations, events, riders,
              and org members. You will be logged out afterwards.
            </div>
          </div>
      ...
      <div className="section">
        ...
        <div className="card">
          <div className="muted small-text" style={{ marginBottom: 12 }}>
            Transfer ownership to any user by email. No permission checks.
          </div>
